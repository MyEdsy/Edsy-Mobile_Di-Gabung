...
class utilsApps{
  ...
  static void dengerSnack(BuildContext context, String text) {
    Flushbar(
      ...
      boxShadows: [
        BoxShadow(
            color: Colors.red, offset: Offset(0.0, 2.0), blurRadius: 3.0)
      ],
      backgroundGradient:
  ...
  static void dengerSnackWithDuration(BuildContext context, String text, var duration) {
    Flushbar(
      message: text,
      flushbarPosition: FlushbarPosition.TOP,
      flushbarStyle: FlushbarStyle.FLOATING,
  ...
  static String displayTimeAgoFromTimestamp(String dateString, {bool numericDates = true}) {

    //DateTime tempDate = new DateFormat("yyyy-MM-DDTHH:mm:ss").parse
    DateTime date = new DateFormat("yyyy-MM-DDTHH:mm:ss").parse(dateString, numericDates).toLocal();
    print(date);
  ...
  static void successDownloadSnack(BuildContext context, String text, String path) {
    Flushbar(
      message: text,
      flushbarPosition: FlushbarPosition.TOP,
      flushbarStyle: FlushbarStyle.FLOATING,
