...
class ComponentQuizSiswa extends StatefulWidget {
  @override
  _ComponentQuiz createState() => _ComponentQuiz();
}

class _ComponentQuiz extends State<ComponentQuizSiswa>
        ...
        Expanded(
          ...
          onTap: () {
            if (index['bolehUjian'] == true) {
              Navigator.pushNamed(context, DetailQuizSiswa.routeName,
                  arguments: {
                    "NIP": MenuQuizSiswa.dataMapelPerIndex['NIP'],
                    "idMapel": MenuQuizSiswa.dataMapelPerIndex['idMapel'],
                    "idkelompokkls":
                        MenuQuizSiswa.dataMapelPerIndex['idkelompokkls'],
                    "Namamapel": MenuQuizSiswa.dataMapelPerIndex['Namamapel'],
                    "KelompokKelas":
                        MenuQuizSiswa.dataMapelPerIndex['KelompokKelas'],
                    "NamaKelompokKelas":
                        MenuQuizSiswa.dataMapelPerIndex['NamaKelompokKelas'],
                    "Jurusan": MenuQuizSiswa.dataMapelPerIndex['Jurusan'],
  ...
  Future<String> getData() async {
    ...
    try {
      final response = await http.get(
          "${getTugas}Quiz/${MenuQuizSiswa.dataMapelPerIndex['Nip']}/${MenuQuizSiswa.dataMapelPerIndex['idMapel']}/${MenuQuizSiswa.dataMapelPerIndex['idkelompokkls']}/${dataTahunAjaran['tahunakademik']}/${dataTahunAjaran['semester']}?nisn=${data['username']}",
          headers: headers);
