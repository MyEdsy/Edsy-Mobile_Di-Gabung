...
class ComponentTugasSiswa extends StatefulWidget {
  @override
  _ComponentTugasSiswa createState() => _ComponentTugasSiswa();
}

class _ComponentTugasSiswa extends State<ComponentTugasSiswa> {
  var isLoading = false;
  var responseJson;
  var status, code;
  ...
  Widget _buildCard2(String name, String kelas, data, String index,
      String imgPath, bool added, bool isFavorite, context) {
    return Row(
      children: <Widget>[
        Expanded(
            child: GestureDetector(
          onTap: () => Navigator.pushNamed(context, MenuTugasSiswa.routeName,
              arguments: data),
          child: Container(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(kelas, style: mServiceSubtitleStyle)
                    ],
                  ),
                )
              ],
