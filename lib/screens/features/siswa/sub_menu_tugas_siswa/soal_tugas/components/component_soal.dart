...
class _SignFormState extends State<komponentSoal> {
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return _listMataPelajaran(
                      ...
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            dataSoal[index]['jawaban'] = jawabArray[index].text;
                            var jawaban = {
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          _launched = _launchInBrowser(urlReal);
                        },
                        child: const Chip(
                          materialTapTargetSize:
                              MaterialTapTargetSize.shrinkWrap,
                      ...
                      GestureDetector(
                        onTap: () {
                          setState(() {
                            var urlFake =
                                '${baseUrlJawaban}${dataSoal[index]['jawaban_file']}';
                            var urlReal = urlFake.replaceAll(" ", "%20");
                            _launched = _launchInBrowser(urlReal);
                          });
                        },
  ...
  _listMataPelajaran(
    ...
    print(jawabanFile);
    if (SoalTugasSiswa.dataTugas['type'] == 'Essay') {
    ...
    } else if (SoalTugasSiswa.dataTugas['type'] == 'File') {
      return Row(
        children: [
          Expanded(
              child: Container(
                        ...
                        setState(() {
                          ...
                          var jawaban = {
                            "idDetailTugas":
                                '${dataSoal[index]['idDetailTugas']}',
                            "idDetailTugas":
                                '${SoalTugasSiswa.dataTugas['idDetailSoal']}',
                            "id_soal": dataSoal[index]['id'],
                            "nisn": dataSoal[index]['nisn'],
                            "nilai_per_soal": '$nilaiNya',
                            "jawaban": dataSoal[index]['jawaban']
  ...
  Future<String> getData() async {
    ...
    try {
      final response = await http.get(
          "${getSoalDanJawabanByNisn}${data['username']}/${SoalTugasSiswa.dataTugas['idDetailSoal']}",
          headers: headers);
