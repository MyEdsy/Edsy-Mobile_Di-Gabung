  ...
  Future<String> getData() async {
    ...
    try {
      final response = await http.get(
          "${bahanAjar}${BahanMengajarSiswa.dataMapelPerIndex['Nip']}/${BahanMengajarSiswa.dataMapelPerIndex['idMapel']}/${BahanMengajarSiswa.dataMapelPerIndex['idkelompokkls']}",
          headers: headers);
                              ...
                              ListTile(
                                ...
                                onTap: () {
                                  ...
                                  if (dataVideo[index2]['sumber_youtube'] ==
                                      'Y') {
                                    Navigator.pushNamed(
                                        context, PlayVideoSiswa.routeName,
                ...
                return ListView(
                  ...
                  children: [
                    ListTile(
                      ...
                      //   var newData = {};
                      //   newData.addAll(idBahanAjar);
                      //   newData.addAll(BahanMengajarSiswa.dataMapelPerIndex);
                      //   Navigator.pushNamed(context, InputVideo.routeName,
                      //       arguments: newData);
                      // },
                    ),
