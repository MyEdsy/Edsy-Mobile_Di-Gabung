...
class PlayVideoSiswa extends StatefulWidget {
  static String routeName = "/play_video_siswa";
  @override
  _PlayVideo createState() => _PlayVideo();
}

class _PlayVideo extends State<PlayVideoSiswa> {
  @override
  ...
  Future<bool> _onBackPressed() async {
    ...
    Navigator.pushNamed(context, BahanMengajarSiswa.routeName,
        arguments: BahanMengajarSiswa.dataMapelPerIndex);
