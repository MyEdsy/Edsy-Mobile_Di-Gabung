...
class ComponentPresensiPerhariSiswa extends StatefulWidget {
  @override
  _ComponentPresensiPerhariSiswa createState() => _ComponentPresensiPerhariSiswa();
}

class _ComponentPresensiPerhariSiswa extends State<ComponentPresensiPerhariSiswa> {
  ...
  Future<String> getData(tanggal, bulan) async {
    ...
    try {
      final response = await http.get(
          "${getPresensiPerhariSiswa}/$tanggal/$bulan/${dataTahunAjaran['tahunakademik']}/${data['username']}",
          headers: headers);
