...
class KomponenJadwalPelajaranSiswa extends StatefulWidget {
  @override
  _KomponenJadwalPelajaranSiswa createState() => _KomponenJadwalPelajaranSiswa();
}

class _KomponenJadwalPelajaranSiswa extends State<KomponenJadwalPelajaranSiswa> {
  var isLoading = false;
