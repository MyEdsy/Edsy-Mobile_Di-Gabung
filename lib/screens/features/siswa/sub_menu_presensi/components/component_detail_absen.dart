...
class ComponenDetailAbsenSiswa extends StatefulWidget {
  @override
  _ComponenDetailAbsenSiswa createState() => _ComponenDetailAbsenSiswa();
}

class _ComponenDetailAbsenSiswa extends State<ComponenDetailAbsenSiswa> {
  var isLoading = false;
  ...
  Future<String> getData() async {
    ...
    try {
      final response = await http.get(
          "${getPrensiSiswaByIdSetJadwalNisn}/${DetailAbsenSiswa.dataMapelFromRoutes['idsetjadwal']}/${dataUser['username']}",
          headers: headers);
