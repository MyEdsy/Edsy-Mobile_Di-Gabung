...
import '../../sub_menu_statistik_tugas/model/nilaiModel.dart';
...
class _BarChart extends State<BarChart> {
  ...
  void initState() {
    ...
    super.initState();
    getData(StatistikQuiz.dataTugas['id']);
  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child: ListView(
          ...
          primary: false,
          children: [
            Text("${ScreenDataQuiz.dataMapelPerIndex['Namamapel']}",
                style: mTitleStyle),
            Text("${ScreenDataQuiz.dataMapelPerIndex['Kodekelas']}",
                style: mTitleStyle),
            Text("${StatistikQuiz.dataTugas['nama_tugas']}",
                style: mTitleStyle),
            SizedBox(height: 10),
            isLoading
                ? Center(
                  ...
                  ListView(
                    ...
                    children: [
                      ListView.separated(
                          ...
                          itemCount: daftarNilaiSiswa == null ? 0 : daftarNilaiSiswa.length,
  ...
  Future<String> getData(id) async {
    ...
    print("${getStatistikTugas}/$id");
    try {
      final response = await http.get(
          "${getStatistikTugas}/$id",
          headers: headers);
      ...
      setState(() {
        ...
        if (status == true && code == 200) {
          ...
          List<NilaiModel> tempdata = genderModelFromJson(json.encode(dataStatistik['distribusiNilaiJml']));
