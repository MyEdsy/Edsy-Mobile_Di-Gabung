...
import '../Screens/ScreenMataPelajaran.dart';

class ComponentMatapelajaranStatistikQuiz extends StatefulWidget {
  @override
  _ComponentMatapelajaranStatistikQuiz createState() => _ComponentMatapelajaranStatistikQuiz();
}

class _ComponentMatapelajaranStatistikQuiz extends State<ComponentMatapelajaranStatistikQuiz> {
  var isLoading = false;
  var responseJson;
  var status, code;
      ...
      children: <Widget>[
        Expanded(
            child: GestureDetector(
              onTap: () => Navigator.pushNamed(context, ScreenDataQuiz.routeName,
                  arguments: data),
              child: Container(
