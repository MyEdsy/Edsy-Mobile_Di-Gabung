...
class FormUpdateSoalUjian extends StatefulWidget {
  @override
  _FormUpdateSoalUjian createState() => _FormUpdateSoalUjian();
}

class _FormUpdateSoalUjian extends State<FormUpdateSoalUjian> {
  ...
  void initState() {
    super.initState();
    setState(() {
      namaSoalText.text = UpdateSoalUjian.data['soal'];
    });
  }
      ...
      child: Column(
        ...
        children: [
          ...
          DefaultButton(
            text: "Submit",
            press: () {
              if (UpdateSoalUjian.data['file'] == null) {
                SoalUjianResponse.updateSoalRes(namaSoalText.text,
                    '${UpdateSoalUjian.data['idSoal']}', context);
              } else {
                print("soal file");
              }
            },
