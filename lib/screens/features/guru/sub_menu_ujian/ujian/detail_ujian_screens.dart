...
import 'component/body_detail_ujian.dart';

class DetailUjian extends StatefulWidget {
  static String routeName = "/detail_ujian";
  static var dataTugasFromDetailTugas;
  @override
  _DetailUjian createState() => _DetailUjian();
}

class _DetailUjian extends State<DetailUjian> {
  ...
  Widget build(BuildContext context) {
    DetailUjian.dataTugasFromDetailTugas = ModalRoute.of(context)!.settings.arguments as Map;
    ...
    return WillPopScope(
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: HeadersForMenu('Detail Ujian'),
            actions: [
              Container(
                child: IconButton(
                    icon: Icon(Icons.add),
  ...
  _popUp() {
    ...
    Widget OK = GestureDetector(
        onTap: () async{
          ...
          await Navigator.pushNamed(context, InputSoalUjian.routeName, arguments: {
            "typeSoal": type,
            "jumlahSoal": myInt,
            "idTugas": data['id']
          });
