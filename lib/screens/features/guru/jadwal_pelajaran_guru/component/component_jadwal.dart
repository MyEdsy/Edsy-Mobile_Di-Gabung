...
class KomponenJadwalPelajaranGuru extends StatefulWidget {
  @override
  _SignFormState createState() => _SignFormState();
}

class _SignFormState extends State<KomponenJadwalPelajaranGuru> {
  var isLoading = false;
  ...
  Future<String> getData() async {
    ...
    try {
      final response = await http.get(
          "${jadwalGuru}${dataTahunAjaran['tahunakademik']}/${dataTahunAjaran['semester']}/${data['username']}",
          headers: headers);
