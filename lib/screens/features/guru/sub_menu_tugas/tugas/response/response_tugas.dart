...
class KomponenTugasResponse {
  ...
  static Future konfirmasiPemeriksaanRes(
      datas,
      BuildContext context) async {
    utilsApps.showDialog(context);
    Map<String, String> headers = {
    ...
    try {
      final response = await http.post(konfirmasiPemeriksaan,
          headers: headers,
  ...
  static Future konfirmasiPemeriksaanQuizRes(
      datas,
      BuildContext context) async {
    utilsApps.showDialog(context);
    Map<String, String> headers = {
      ...
      if (status == true && code == 200) {
        Future.delayed(Duration(seconds: 1)).then((value) {
          ...
          AwesomeDialog(
                  ...
                  btnOkOnPress: () {
                    Navigator.pushNamed(context, MenuTugas.routeName,
                        arguments: UpdateTugas.dataMapelPerIndex);
                  },
                  btnOkIcon: Icons.check,
                  btnOkColor: kColorTealToSlow)
              .show();
