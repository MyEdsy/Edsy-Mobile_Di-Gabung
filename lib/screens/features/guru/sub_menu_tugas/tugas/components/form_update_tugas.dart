...
class FormUpdateTugas extends StatefulWidget {
  @override
  _FormInputTugas createState() => _FormInputTugas();
}

class _FormInputTugas extends State<FormUpdateTugas> {
  ...
  void initState() {
    ...
    super.initState();
    setState(() {
      namaTugasText.text = UpdateTugas.dataMapelPerIndex['nama_tugas'];
      keteranganText.text = UpdateTugas.dataMapelPerIndex['keterangan'];
      txtFilterTglMulai.text = UpdateTugas.dataMapelPerIndex['tgl_mulai'];
      txtFilterTglSelesai.text = UpdateTugas.dataMapelPerIndex['tgl_selesai'];
    });
  }
      ...
      child: Column(
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Chip(
                  ...
                  label: Text(MenuTugas.dataMapelPerIndex['Namamapel'],
                      style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
                          color: Colors.white)),
            ...
            child: Column(
              ...
              children: [
                ...
                Chip(
                  ...
                  label: Text(
                      '${MenuTugas.dataMapelPerIndex['KelompokKelas']} ${MenuTugas.dataMapelPerIndex['Jurusan']} ${MenuTugas.dataMapelPerIndex['NamaKelompokKelas']}',
                      style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
                          color: Colors.white)),
          ...
          DefaultButton(
            text: "Submit",
            press: () {
              KomponenTugasResponse.updateTugasRes(
                  '${UpdateTugas.dataMapelPerIndex['id']}',
                  namaTugasText.text,
                  keteranganText.text,
  ...
  Widget dropDownListKomponeneNilai() {
    var data = DropdownSearch<KomponenNilai>(
      ...
      showSearchBox: true,
      hint: UpdateTugas.dataMapelPerIndex['tb_komponen_nilai']['nama_komponen'],
  ...
  Widget dropDownType() {
    return DropdownSearch<String>(
      ...
      items: ["Essay", "File"],
      label: "Type",
      hint: UpdateTugas.dataMapelPerIndex['type'],
  ...
  Future<List<KomponenNilai>?> getKomponen(filter) async {
    ...
    var response = await dio.get(
      '${komponenNilaiAll}$filter/${UpdateTugas.dataMapelPerIndex['NIP']}/${UpdateTugas.dataMapelPerIndex['idMapel']}/${UpdateTugas.dataMapelPerIndex['idkelompokkls']}',
    );
    print(response.data);
