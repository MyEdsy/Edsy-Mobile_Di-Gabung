...
import '../update_tugas_screens.dart';
        ...
        Expanded(
          ...
          onTap: () {
            Navigator.pushNamed(context, DetailTugas.routeName, arguments: {
              "NIP": MenuTugas.dataMapelPerIndex['NIP'],
              "idMapel": MenuTugas.dataMapelPerIndex['idMapel'],
              "idkelompokkls": MenuTugas.dataMapelPerIndex['idkelompokkls'],
              "Namamapel": MenuTugas.dataMapelPerIndex['Namamapel'],
              "KelompokKelas": MenuTugas.dataMapelPerIndex['KelompokKelas'],
              "NamaKelompokKelas":
                  MenuTugas.dataMapelPerIndex['NamaKelompokKelas'],
              "Jurusan": MenuTugas.dataMapelPerIndex['Jurusan'],
  ...
  Future<String> getData() async {
    ...
    try {
      final response = await http.get(
          "${getTugas}Tugas/${MenuTugas.dataMapelPerIndex['NIP']}/${MenuTugas.dataMapelPerIndex['idMapel']}/${MenuTugas.dataMapelPerIndex['idkelompokkls']}/${dataTahunAjaran['tahunakademik']}/${dataTahunAjaran['semester']}",
          headers: headers);
