...
class FormInputTugas extends StatefulWidget {
  @override
  _FormInputTugas createState() => _FormInputTugas();
}

class _FormInputTugas extends State<FormInputTugas> {
  ...
  String namaKomponen = '', idKomponen = '';
  String? type;
  ...
  Widget build(BuildContext context) {
    print(InputTugas.dataMapelPerIndex);
    return Container(
      padding:
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Chip(
                  ...
                  label: Text(InputTugas.dataMapelPerIndex['Namamapel'],
                      style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
                          color: Colors.white)),
            ...
            child: Column(
              ...
              children: [
                ...
                Chip(
                  ...
                  label: Text(
                      '${InputTugas.dataMapelPerIndex['KelompokKelas']} ${InputTugas.dataMapelPerIndex['Jurusan']} ${InputTugas.dataMapelPerIndex['NamaKelompokKelas']}',
                      style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
                          color: Colors.white)),
          ...
          DefaultButton(
            ...
            press: () {
              ...
              KomponenTugasResponse.inputTugasRes(
                  InputTugas.dataMapelPerIndex['NIP'],
                  '${InputTugas.dataMapelPerIndex['idkelompokkls']}',
                  // type,
                  txtFilterTglMulai.text,
                  txtFilterTglSelesai.text,
                  '0',
                  keteranganText.text,
                  '${InputTugas.dataMapelPerIndex['idMapel']}',
  ...
  Future<List<KomponenNilai>?> getKomponen(filter) async {
    ...
    var response = await dio.get(
      '${komponenNilaiAll}$filter/${InputTugas.dataMapelPerIndex['NIP']}/${InputTugas.dataMapelPerIndex['idMapel']}/${InputTugas.dataMapelPerIndex['idkelompokkls']}',
    );
    print(response.data);
