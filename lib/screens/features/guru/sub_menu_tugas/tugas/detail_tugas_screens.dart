...
class _DetailTugas extends State<DetailTugas> {
  ...
  Widget build(BuildContext context) {
    DetailTugas.dataTugasFromDetailTugas = ModalRoute.of(context)!.settings.arguments as Map;
  ...
  _popUp() {
    ...
    Widget OK = GestureDetector(
        onTap: () async{
          ...
          await Navigator.pushNamed(context, InputSoalEssay.routeName, arguments: {
            "typeSoal": type,
            "jumlahSoal": myInt,
            "idTugas": data['id'],
