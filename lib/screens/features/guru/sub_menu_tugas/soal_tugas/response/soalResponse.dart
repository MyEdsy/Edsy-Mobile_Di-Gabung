...
class SoalResponse {
      ...
      if (status == true && code == 200) {
        Future.delayed(Duration(seconds: 1)).then((value) {
          ...
          AwesomeDialog(
                  ...
                  desc: responseJson['message'],
                  btnOkOnPress: () {
                    Navigator.pushNamed(context, SoalTugas.routeName,
                        arguments: UpdateSoalEssay.data);
                  },
                  btnOkIcon: Icons.check,
                  btnOkColor: kColorTealToSlow)
              .show();
  ...
  static Future inputNilaisPersiswa(datas, BuildContext context) async {
    // utilsApps.showDialog(context);
    Map<String, String> headers = {
      'Content-Type': 'application/json;charset=UTF-8',
      'Charset': 'utf-8',
    ...
    try {
      final response = await http.put('${inputNilai}',
          headers: headers,
