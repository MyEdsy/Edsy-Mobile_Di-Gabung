  ...
  _popUpHapusData(namaKomponen, idKomponen, contex) {
    AwesomeDialog(
            ...
            onDissmissCallback: (type) {
              KomponenNilaiResponse.hapusKomponenNilaiRes(
                  idKomponen, context);
            },
  ...
  Future<String> getData() async {
    ...
    try {
      final response = await http.get(
          "${komponenNilai}${InputKategoriNilai.dataMapelFromRoutes['idKomponen']}/${InputKategoriNilai.dataMapelFromRoutes['NIP']}/${InputKategoriNilai.dataMapelFromRoutes['idMapel']}/${InputKategoriNilai.dataMapelFromRoutes['idkelompokkls']}",
          headers: headers);
