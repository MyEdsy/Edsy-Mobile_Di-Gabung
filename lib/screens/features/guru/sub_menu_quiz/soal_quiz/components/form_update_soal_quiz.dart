...
class FormUpdateSoalQuiz extends StatefulWidget {
  @override
  _FormUpdateSoalQuiz createState() => _FormUpdateSoalQuiz();
}

class _FormUpdateSoalQuiz extends State<FormUpdateSoalQuiz> {
  ...
  void initState() {
    super.initState();
    setState(() {
      namaSoalText.text = UpdateSoalQuiz.data['soal'];
    });
  }
      ...
      child: Column(
        ...
        children: [
          ...
          DefaultButton(
            text: "Submit",
            press: () {
              if (UpdateSoalQuiz.data['file'] == null) {
                SoalQuizResponse.updateSoalRes(namaSoalText.text,
                    '${UpdateSoalQuiz.data['idSoal']}', context);
              } else {
                print("soal file");
              }
            },
