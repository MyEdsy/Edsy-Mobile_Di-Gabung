...
import '../jawaban_quiz_screen.dart';

class komponentJawabanQuiz extends StatefulWidget {
  @override
  _komponentJawaban createState() => _komponentJawaban();
}

class _komponentJawaban extends State<komponentJawabanQuiz> {
  var isLoading = false;
  ...
  _listMataPelajaran(
    ...
    if (JawabanQuizSiswaDiGuru.dataSoal['type'] == "Essay") {
      return Row(
        children: [
          Expanded(
              child: Container(
                    ...
                    Container(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: Icon(FontAwesomeIcons.firstOrder),
    ...
    } else if (JawabanQuizSiswaDiGuru.dataSoal['type'] == "PG") {
      return Row(
        children: [
          Expanded(
              child: Container(
  ...
  Future<String> getData() async {
    ...
    try {
      final response = await http.get(
          "${jawabanByIdSoal}${JawabanQuizSiswaDiGuru.dataSoal['id']}",
          headers: headers);
