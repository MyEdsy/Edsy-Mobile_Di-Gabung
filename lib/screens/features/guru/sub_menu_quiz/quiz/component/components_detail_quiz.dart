                    ...
                    return _listMataPelajaran(
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          Navigator.pushNamed(context, SoalQuiz.routeName,
                              arguments: {
                                "idDetailSoal": dataDetailTugas[index]['id'],
                                "idTugas":
                                    DetailQuiz.dataTugasFromDetailTugas['id'],
                                "keterangan" : DetailQuiz.dataTugasFromDetailTugas['keterangan'],
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          var kirimData = {
                            ...
                            "idTugas" : '${DetailQuiz.dataTugasFromDetailTugas['id']}',
                            "bobot" : '${dataDetailTugas[index]['bobot']}',
                          };
                          KomponenTugasResponse.konfirmasiPemeriksaanQuizRes(kirimData, context);
                        },
                        child: const Chip(
                          materialTapTargetSize:
                          MaterialTapTargetSize.shrinkWrap,
  ...
  Future<String> getData() async {
    ...
    try {
      final response = await http.get(
          "${getdetailTugas}${DetailQuiz.dataTugasFromDetailTugas['id']}",
          headers: headers);
