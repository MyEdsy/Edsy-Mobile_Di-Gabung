...
import 'package:school_apps/screens/features/guru/sub_menu_quiz/quiz/response/quiz_response.dart';
...
class FormUpdatequiz extends StatefulWidget {
  @override
  _FormUpdatequiz createState() => _FormUpdatequiz();
}

class _FormUpdatequiz extends State<FormUpdatequiz> {
  ...
  void initState() {
    ...
    super.initState();
    setState(() {
      namaTugasText.text = UpdateQuiz.dataMapelPerIndex['nama_tugas'];
      keteranganText.text = UpdateQuiz.dataMapelPerIndex['keterangan'];
      txtFilterTglMulai.text = UpdateQuiz.dataMapelPerIndex['tgl_mulai'];
      txtFilterTglSelesai.text = UpdateQuiz.dataMapelPerIndex['tgl_selesai'];
    });
  }
      ...
      child: Column(
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Chip(
                  ...
                  label: Text(MenuQuiz.dataMapelPerIndex['Namamapel'],
                      style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
                          color: Colors.white)),
            ...
            child: Column(
              ...
              children: [
                ...
                Chip(
                  ...
                  label: Text(
                      '${MenuQuiz.dataMapelPerIndex['KelompokKelas']} ${MenuQuiz.dataMapelPerIndex['Jurusan']} ${MenuQuiz.dataMapelPerIndex['NamaKelompokKelas']}',
                      style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
                          color: Colors.white)),
          ...
          DefaultButton(
            text: "Submit",
            press: () {
              QuizResponse.updateTugasRes(
                  '${UpdateQuiz.dataMapelPerIndex['id']}',
                  namaTugasText.text,
                  keteranganText.text,
  ...
  Widget dropDownListKomponeneNilai() {
    var data = DropdownSearch<KomponenNilai>(
      ...
      showSearchBox: true,
      hint: UpdateQuiz.dataMapelPerIndex['tb_komponen_nilai']['nama_komponen'],
  ...
  Widget dropDownType() {
    return DropdownSearch<String>(
      ...
      items: ["Essay", "File"],
      label: "Type",
      hint: UpdateQuiz.dataMapelPerIndex['type'],
  ...
  Future<List<KomponenNilai>?> getKomponen(filter) async {
    ...
    var response = await dio.get(
      '${komponenNilaiAll}$filter/${UpdateQuiz.dataMapelPerIndex['NIP']}/${UpdateQuiz.dataMapelPerIndex['idMapel']}/${UpdateQuiz.dataMapelPerIndex['idkelompokkls']}',
    );
    print(response.data);
