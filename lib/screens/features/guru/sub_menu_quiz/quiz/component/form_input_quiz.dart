...
class FormInputQuiz extends StatefulWidget {
  @override
  _FormInputQuiz createState() => _FormInputQuiz();
}

class _FormInputQuiz extends State<FormInputQuiz> {
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Chip(
                  ...
                  label: Text(InputQuiz.dataMapelPerIndex['Namamapel'],
                      style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
                          color: Colors.white)),
            ...
            child: Column(
              ...
              children: [
                ...
                Chip(
                  ...
                  label: Text(
                      "${InputQuiz.dataMapelPerIndex['KelompokKelas']} ${InputQuiz.dataMapelPerIndex['Jurusan']} ${InputQuiz.dataMapelPerIndex['NamaKelompokKelas']}",
                      style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
                          color: Colors.white)),
          ...
          DefaultButton(
            ...
            press: () {
              ...
              QuizResponse.inputTugasRes(
                  InputQuiz.dataMapelPerIndex['NIP'],
                  '${InputQuiz.dataMapelPerIndex['idkelompokkls']}',
                  // type,
                  txtFilterTglMulai.text,
                  txtFilterTglSelesai.text,
                  idKomponen,
                  keteranganText.text,
                  '${InputQuiz.dataMapelPerIndex['idMapel']}',
  ...
  Widget dropDownMaterListKomponeneNilai() {
    var data = DropdownSearch<MasterKomponenNilai>(
      ...
      onChanged: (MasterKomponenNilai data) => {
        idMasterKomponen = '${data.idkompnilai}',
        namaMaterKomponen = data.nama_komponen
      },
    );
    return data;
  }
  ...
  Future<List<KomponenNilai>?> getKomponen(filter) async {
    ...
    dio.options.headers["username"] = data['username'];
    var response = await dio.get(
      '${komponenNilaiAll}$filter/${InputQuiz.dataMapelPerIndex['NIP']}/${InputQuiz.dataMapelPerIndex['idMapel']}/${InputQuiz.dataMapelPerIndex['idkelompokkls']}',
    );
