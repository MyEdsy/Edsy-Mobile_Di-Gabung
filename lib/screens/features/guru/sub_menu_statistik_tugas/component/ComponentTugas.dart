      ...
      children: <Widget>[
        Expanded(
            child: GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, StatistikTugas.routeName, arguments: {
  ...
  Future<String> getData() async {
    ...
    try {
      final response = await http.get(
          "${getTugas}Tugas/${data['username']}/${SubMenuMataStatistikTugas.dataMapelPerIndex['idMapel']}/${SubMenuMataStatistikTugas.dataMapelPerIndex['idkelompokkls']}/${dataTahunAjaran['tahunakademik']}/${dataTahunAjaran['semester']}",
          headers: headers);
