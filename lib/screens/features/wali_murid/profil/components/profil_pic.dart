...
class WaliMuridProfilePic extends StatefulWidget{
  const WaliMuridProfilePic({
    Key? key,
  }) : super(key: key);

  @override
  _WaliMuridProfilePic createState() => _WaliMuridProfilePic();
}


class _WaliMuridProfilePic extends State<WaliMuridProfilePic> {
