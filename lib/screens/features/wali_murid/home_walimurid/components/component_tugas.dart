...
class WaliMuridTugas extends StatefulWidget {
  const WaliMuridTugas({Key? key}) : super(key: key);

  @override
  _WaliMuridTugas createState() => _WaliMuridTugas();
}

class _WaliMuridTugas extends State<WaliMuridTugas> {
  @override
