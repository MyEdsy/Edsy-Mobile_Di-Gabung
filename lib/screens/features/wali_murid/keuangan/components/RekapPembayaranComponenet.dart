...
class WaliMuridRekapPembayaranComponent extends StatefulWidget {
  const WaliMuridRekapPembayaranComponent({Key? key}) : super(key: key);

  @override
  _SignFormState createState() => _SignFormState();
}

class _SignFormState extends State<WaliMuridRekapPembayaranComponent> {
  var isLoading = false;
  var responseJson;
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return _dataTagihan(
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.pushNamed(
                                    context, WaliMuridDetailRekapScreens.routeName,
                                    arguments: {
                                      'id_paket_pembayaran':
  ...
  Future<String> getData() async {
    ...
    try {
      final response = await http.get("${rekapTransaksi}/${data['nisn']}",
          headers: headers);
