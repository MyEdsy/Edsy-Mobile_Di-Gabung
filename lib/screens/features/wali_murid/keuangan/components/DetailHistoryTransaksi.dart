...
class WaliMuridDetailHistoryComponenet extends StatefulWidget {
  const WaliMuridDetailHistoryComponenet({Key? key}) : super(key: key);

  @override
  _SignFormState createState() => _SignFormState();
}

class _SignFormState extends State<WaliMuridDetailHistoryComponenet> {
  ...
  void initState() {
    ...
    super.initState();
    getData(WaliMuridDetailHistoryScreens.args['id_paket_pembayaran']);
  }
      ...
      children: [
          ...
          children: [
            Container(
              ...
              child: Chip(
                ...
                label: Text(
                  'No. Tagihan ${WaliMuridDetailHistoryScreens.args['noInvoice']}',
        ...
        Row(
          children: [
            Container(
              ...
              child: Chip(
                materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
                avatar: const Icon(FontAwesomeIcons.calendar, color: Colors.white,),
                label: Text(
                  'Tgl. Transaksi ${parseDateIndoFullNameMount(WaliMuridDetailHistoryScreens.args['tglTransaksi'])}',
                  style: const TextStyle(
                      color: Colors.white,
                      fontSize: 14,
                      fontWeight: FontWeight.bold),
        ...
        isLoading
          ...
          children: [
            ...
            WaliMuridDetailHistoryScreens.args['bukti_bayar'] != null ?
            Container(
              margin: const EdgeInsets.only(left: 16, right: 16),
              child: Image.network(
                '$buktiBayarUrl${WaliMuridDetailHistoryScreens.args['bukti_bayar']}',
