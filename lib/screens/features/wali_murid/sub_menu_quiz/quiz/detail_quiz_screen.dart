...
import 'components/body_detail_quiz.dart';

class WaliMuridDetailQuizSiswa extends StatefulWidget {
  static String routeName = "/walimurid_detail_quiz_siswa";
  static var dataTugasFromDetailTugas;

  const WaliMuridDetailQuizSiswa({Key? key}) : super(key: key);
  @override
  _DetailQuiz createState() => _DetailQuiz();
}

class _DetailQuiz extends State<WaliMuridDetailQuizSiswa> {
  ...
  Widget build(BuildContext context) {
    WaliMuridDetailQuizSiswa.dataTugasFromDetailTugas = ModalRoute.of(context)!.settings.arguments as Map;
    ...
    return WillPopScope(
        child: Scaffold(
          ...
          backgroundColor: mBackgroundColor,
          body: const WaliMuridBodyDetailQuizSiswa(),
        ),
  ...
  Future<bool> _onBackPressed() async {
    ...
    Navigator.pushNamed(context, WaliMuridMenuQuizSiswa.routeName,
        arguments: WaliMuridMenuQuizSiswa.dataMapelPerIndex);
