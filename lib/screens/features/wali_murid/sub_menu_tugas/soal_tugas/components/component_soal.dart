...
class _SignFormState extends State<WaliMuridkomponentSoal> {
  ...
  _listMataPelajaran(
    ...
    print(jawabanFile);
    if (WaliMuridSoalTugasSiswa.dataTugas['type'] == 'Essay') {
    ...
    } else if (WaliMuridSoalTugasSiswa.dataTugas['type'] == 'File') {
      return Row(
        children: [
          Expanded(
              child: Container(
                        ...
                        setState(() {
                          ...
                          var jawaban = {
                            "idDetailTugas":
                                '${dataSoal[index]['idDetailTugas']}',
                            "idDetailTugas":
                                '${WaliMuridSoalTugasSiswa.dataTugas['idDetailSoal']}',
                            "id_soal": dataSoal[index]['id'],
                            "nisn": dataSoal[index]['nisn'],
                            "nilai_per_soal": '$nilaiNya',
                            "jawaban": dataSoal[index]['jawaban']
  ...
  Future<String> getData() async {
    ...
    try {
      final response = await http.get(
          "${getSoalDanJawabanByNisn}${data['nisn']}/${WaliMuridSoalTugasSiswa.dataTugas['idDetailSoal']}",
          headers: headers);
