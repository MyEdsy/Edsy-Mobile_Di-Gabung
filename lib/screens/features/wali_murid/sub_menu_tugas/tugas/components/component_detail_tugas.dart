...
class WaliMuridComponentDetailTugas extends StatefulWidget {
  static var detailTugas;

  const WaliMuridComponentDetailTugas({Key? key}) : super(key: key);
  @override
  _ComponentBahanAjar createState() => _ComponentBahanAjar();
}

class _ComponentBahanAjar extends State<WaliMuridComponentDetailTugas> {
              ...
              ListView.separated(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return _listMataPelajaran(
                      ...
                      GestureDetector(
                        onTap: () {
                          // Navigator.pushNamed(context, WaliMuridSoalTugasSiswa.routeName,
                          //     arguments: {
                          //       "idDetailSoal": dataDetailTugas[index]['id'],
                          //       "idTugas": WaliMuridDetailTugasSiswa
                          //           .dataTugasFromDetailTugas['id'],
                          //       "keterangan": WaliMuridDetailTugasSiswa
                          //           .dataTugasFromDetailTugas['keterangan'],
                          //       "type": dataDetailTugas[index]['type'],
                          //       "link_youtube" : WaliMuridDetailTugasSiswa.dataTugasFromDetailTugas['link_youtube'],
                          //       "link_sumberlain" : WaliMuridDetailTugasSiswa.dataTugasFromDetailTugas['link_sumberlain'],
                          //     });
                        },
                        // child: const Chip(
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          // };
                          // WalimuridKonfirmResponse2.konfirmasiJawaban(kirim, context);
                        },
                        // child: const Chip(
                        //   materialTapTargetSize:
                        //   MaterialTapTargetSize.shrinkWrap,
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      overflow: TextOverflow.ellipsis,
                      style:
                          const TextStyle(color: Colors.grey, fontSize: 15.3),
                    ),
                  )
                ],
              ),
  ...
  Future<String> getData() async {
    ...
    try {
      final response = await http.get(
          "${getdetailTugasSiswa}${WaliMuridDetailTugasSiswa.dataTugasFromDetailTugas['id']}/${data['nisn']}",
          headers: headers);
      ...
      setState(() {
        ...
        if (status == true && code == 200) {
          ...
          WaliMuridComponentDetailTugas.detailTugas = dataDetailTugas;
