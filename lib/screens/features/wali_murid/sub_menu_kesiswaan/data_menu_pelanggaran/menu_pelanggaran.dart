...
import 'package:school_apps/screens/features/wali_murid/sub_menu_kesiswaan/components/card_pelanggaran.dart';
...
class WaliMuridMenuPelanggaran extends StatefulWidget {
  static String routeName = '/walimurid_menu_pelanggaran';

  const WaliMuridMenuPelanggaran({Key? key}) : super(key: key);

  @override
  State<WaliMuridMenuPelanggaran> createState() => _WaliMuridMenuPelanggaran();
}

class _WaliMuridMenuPelanggaran extends State<WaliMuridMenuPelanggaran> {
  @override
  ...
  Future<bool> _onBackPressed() async {
    Navigator.push(
      ...
      PageTransition(
        ...
        child: const WaliMuridSubMenuKesiswaan(),
      ),
    );
      ...
      children: [
        ...
        ListView.separated(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return WaliMuridCardPelanggaran(
                  text: dataPelanggaranSiswa[index]['kasus'],
                  icon: "assets/icons/order.svg",
                  press: () {
                    Navigator.of(context, rootNavigator: true).pushNamed(
                      WaliMuridDetailPelanggaran.routeName,
                      arguments: {
